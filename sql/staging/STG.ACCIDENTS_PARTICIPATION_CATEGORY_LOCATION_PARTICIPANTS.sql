...
Basic documentary
--------------------------------------------------------------------------------------------------------------
Name:			DB_DWH.STG.ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_PARTICIPANTS
Object:			Procedure
...
DROP PROCEDURE IF EXISTS STG.RUN_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_PARTICIPANTS;
GO

CREATE PROCEDURE STG.RUN_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_PARTICIPANTS (
...
--Table definition
--------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS DB_DWH.STG.ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_PARTICIPANTS

CREATE TABLE DB_DWH.STG.ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_PARTICIPANTS (
	 [YEAR]								INT
	,[MONTH]							INT
...
INSERT INTO DB_DWH.STG.ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_PARTICIPANTS
