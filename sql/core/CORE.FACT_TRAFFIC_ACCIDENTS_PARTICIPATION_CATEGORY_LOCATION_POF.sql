...
Basic documentary
--------------------------------------------------------------------------------------------------------------
Name:			DB_DWH.CORE.RUN_FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF
Object:			Procedure
...
participants identified as the party of fault.
...
7. Insert the transformed records into
   DB_DWH.CORE.FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF.

Result
--------------------------------------------------------------------------------------------------------------
Fact table containing the number of traffic accident participants identified
as the party of fault.
...
,[PARTICIPANTS]                    INT             Number of participants identified as the party of fault
...
DROP PROCEDURE IF EXISTS CORE.RUN_FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF;
GO

CREATE PROCEDURE CORE.RUN_FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF (
...
--Table definition
--------------------------------------------------------------------------------------------------------------
IF OBJECT_ID('DB_DWH.CORE.FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF') IS NULL
BEGIN

CREATE TABLE DB_DWH.CORE.FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF (
    ...
    ,CONSTRAINT UNIQUE_FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF UNIQUE
    (
         [AGE_ID]
    	,[ROAD_ENVIRONMENT_ID]
...
--Data sources
--------------------------------------------------------------------------------------------------------------
--Table:    #SRC_DAT_TR_ACC_PART_CAT_LOC_POF
...
DROP TABLE IF EXISTS #SRC_DAT_TR_ACC_PART_CAT_LOC_POF
	SELECT
		 SRC.[AGE_CATEGORY]
        ...
        ,SRC.[STAMP_SOURCE]
        ,SRC.[STAMP_TIME]
	INTO #SRC_DAT_TR_ACC_PART_CAT_LOC_POF
...
INSERT INTO DB_DWH.CORE.FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF (
     [AGE_ID]				        
	,[ROAD_ENVIRONMENT_ID]			
	,[TRAFFIC_PARTICIPATION_ID]		
    ,[SEX_ID]                       
...
FROM #SRC_DAT_TR_ACC_PART_CAT_LOC_POF AS SRC
...
WHERE NOT EXISTS (
	SELECT 1
	FROM DB_DWH.CORE.FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF
    WHERE   #SRC_DIM_AGE.[AGE_ID]                                               
            = CORE.FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF.[AGE_ID]
    
    AND     #SRC_DIM_ROAD_ENVIRONMENT.[ROAD_ENVIRONMENT_ID]                     
            = CORE.FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF.[ROAD_ENVIRONMENT_ID]
    
    AND     #SRC_DIM_PARTICIPATION.[TRAFFIC_PARTICIPATION_ID]                   
            = CORE.FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF.[TRAFFIC_PARTICIPATION_ID]
    
    AND     SRC.[SEX_ID]                                                        
            = CORE.FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF.[SEX_ID]
    
    AND     #SRC_DIM_TRAFFIC_ACCIDENT_CATEGORY.[TRAFFIC_ACCIDENT_CATEGORY_ID]   
            = CORE.FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF.[TRAFFIC_ACCIDENT_CATEGORY_ID]
    
    AND     SRC.[YEAR]                                                          
            = CORE.FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF.[YEAR]
    
    AND     SRC.[MONTH]                                                         
            = CORE.FACT_TRAFFIC_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF.[MONTH]
)
