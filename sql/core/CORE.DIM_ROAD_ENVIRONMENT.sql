...
--Data sources
--------------------------------------------------------------------------------------------------------------
--Table:	#SRC_DAT_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_PARTICIPANTS
...
DROP TABLE IF EXISTS #SRC_DAT_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_PARTICIPANTS
	SELECT DISTINCT
		SRC.[ACCIDENT_LOCATION]         AS [ROAD_ENVIRONMENT_DESTATIS]
	INTO #SRC_DAT_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_PARTICIPANTS
	FROM STG.ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_PARTICIPANTS AS SRC

--Table:	#SRC_DAT_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF
--Purpose: 	Extract distinct road environment categories from the staging table.
--Logic:   	Read all available road environment categories without business transformation.
DROP TABLE IF EXISTS #SRC_DAT_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF
	SELECT DISTINCT
		SRC.[ACCIDENT_LOCATION]         AS [ROAD_ENVIRONMENT_DESTATIS]
	INTO #SRC_DAT_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF
	FROM STG.ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF AS SRC

--Table:	#SRC_DAT_TRAFFIC_ACCIDENTS
--Purpose: 	Extract distinct road environment categories from the staging table.
--Logic:   	Read all available road environment categories without business transformation.
DROP TABLE IF EXISTS #SRC_DAT_TRAFFIC_ACCIDENTS
	SELECT DISTINCT
		SRC.[ACCIDENT_LOCATION]         AS [ROAD_ENVIRONMENT_DESTATIS]
	INTO #SRC_DAT_TRAFFIC_ACCIDENTS
...
DROP TABLE IF EXISTS #DIMENSIONS_UNION
	...
	FROM (
		...
		FROM #SRC_DAT_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_PARTICIPANTS

		UNION

		SELECT [ROAD_ENVIRONMENT_DESTATIS]
		FROM #SRC_DAT_ACCIDENTS_PARTICIPATION_CATEGORY_LOCATION_POF

		UNION
		SELECT [ROAD_ENVIRONMENT_DESTATIS]
		FROM #SRC_DAT_TRAFFIC_ACCIDENTS
	) SRC
